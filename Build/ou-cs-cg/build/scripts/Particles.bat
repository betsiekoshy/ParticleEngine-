...
@rem ##########################################################################
@rem
@rem  Particles startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and PARTICLES_OPTS to pass JVM options to this script.
...
@rem Execute Particles
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %PARTICLES_OPTS%  -classpath "%CLASSPATH%" edu.ou.cs.cg.Project.Driver %CMD_LINE_ARGS%
...
:fail
rem Set variable PARTICLES_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%PARTICLES_EXIT_CONSOLE%" exit 1
exit /b 1
